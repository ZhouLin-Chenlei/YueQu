 ...
 */
public class GridView2RowAdapter extends BaseAdapter{
    private List<RProgram> mPrograms;
    public GridView2RowAdapter(List<RProgram> list){
        this.mPrograms = list;
    }
    @Override
    public int getCount() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView = View.inflate(parent.getContext(), R.layout.recommend_video_2row, null);
