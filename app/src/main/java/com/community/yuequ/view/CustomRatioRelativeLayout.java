...
//    private int mAspectRatioHeight = DEFAULT_ASPECT_RATIO_HEIGHT;
	...
	public CustomRatioRelativeLayout(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public CustomRatioRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
